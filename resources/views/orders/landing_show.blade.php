    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Landing Page Order Details
                    <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center py-1">
                ...
                <a href="{{ route('landing-orders-index') }}" class="btn btn-sm btn-primary" id="kt_toolbar_primary_button">Order List</a>
                <!--end::Button-->
            </div>
            <!--end::Actions-->
        </div>
                ...
                <div class="card mt-4">
                    <div class="card-header bg-light bd-cyan">
                        <div class="card-title">
                            <h2>Landing Page Order Details</h2>
                        </div>
                    </div>
                    <!--begin::Body-->
                    <div class="card-body p-1">

                    <form action="{{ route('landing-order-update', $order_id) }}" method="POST">
                    @csrf
                    <div class="row">
                        ...
                        <div class="d-flex align-items-center gap-2 bg-light p-3 mb-1">
                            <span class="fs-6 fw-bolder mb-1 text-gray-900 text-hover-primary w-lg-100px w-xxl-150px">Customer Phone</span><span>{{ $order->order_phone_number }}</span>
                        </div></div>

                        <div class="col-md-6">
                        <div class="d-flex align-items-center gap-2 bg-light p-3 mb-1">
                            <span class="fs-6 fw-bolder mb-1 text-gray-900 text-hover-primary w-lg-100px w-xxl-150px">Customer Name</span><span>{{ $order->full_name }}</span>
                        </div></div>

                        <div class="col-md-6">
                        <div class="d-flex align-items-center gap-2 bg-light p-3 mb-1">
                            <span class="fs-6 fw-bolder mb-1 text-gray-900 text-hover-primary w-lg-100px w-xxl-150px">Address</span><span>{{ $order->billing_address }}</span>
                        </div></div>

                        <div class="col-md-6">
                        <div class="d-flex align-items-center gap-2 bg-light p-3 mb-1">
                            <span class="fs-6 fw-bolder mb-1 text-gray-900 text-hover-primary w-lg-100px w-xxl-150px">Product Name</span><span>{{ $order->name }}</span>
                        </div></div>

                        <div class="col-md-6">
                        <div class="d-flex align-items-center gap-2 bg-light p-3 mb-1">
                            <span class="fs-6 fw-bolder mb-1 text-gray-900 text-hover-primary w-lg-100px w-xxl-150px">Quantity</span><span>{{ $order->quantity }}</span>
                        </div></div>
                        ...
                        <div class="col-md-6">
                        <div class="d-flex align-items-center gap-2 p-3 mb-1" style="background-color:#14A44D">
                            <span class="fs-6 fw-bolder mb-1 text-hover-primary w-lg-100px w-xxl-150px" style="color:#FFF">Total Price: </span><span style="color:#FFF;"><b>{{ $order->final_price }}</b></span>
                        </div></div>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td>{{ $order->name }}</td>
                                    <td style="border:1px solid #ddd;width:100px;"><img style="width: 100%;" src="{{ asset('uploads/products/' . $order->img_path) }}"></td>
